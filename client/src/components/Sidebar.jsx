...
import { Eraser, FileText, Hash, House, Image, LogOutIcon, Scissors, SquarePen, Users } from 'lucide-react'
  ...
  return (
    ...
    ${sidebar ? 'translate-x-0':'max-sm:-translate-x-full' } transition-all duration-300 ease-in-out`}>
        ...
        <div className='w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between'>
              <div className='flex gap-2 flex items-center cursor-pointer' onClick={openUserProfile}>
